...
struct Home: StaticPage {
    ...
    var body: some HTML {
        ...
        Card {
            ...
            Text(markdown: """
            Those images up top link to articles I’ve written recently. Feel free to poke around — I’ll still be here. 🤔
            <br /><br />
            ...
            <br /><br />
            I’m a senior iOS engineer with over 25 years of professional software development experience and more than 12 years focused specifically on iOS. I genuinely love building great apps — the kind that feel solid, fast, accessible, and thoughtfully engineered under the hood.
            <br /><br />
            I’ll be honest: I’m not a designer.  
            What I *am* is the developer who takes a vision (and maybe a rough sketch 😄) and turns it into a polished, high-quality product. I care deeply about clean architecture, performance, maintainability, and making sure apps behave correctly even in the weird edge cases.
            <br /><br />
            ...
            <br /><br />
            My technical sweet spot is Swift, SwiftUI, UIKit, and modern iOS architecture, with a strong emphasis on Test-Driven Development, accessibility, and long-term maintainability. I also really enjoy mentoring developers and sharing what I’ve learned — which is why you’ll find articles, guides, and occasional rants sprinkled throughout this site.
            <br /><br />
